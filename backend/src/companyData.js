...
var url = "mongodb://localhost:27017/demoapp-development";
...
function fetchData(companyName) {
    return __awaiter(this, void 0, void 0, function () {
        var db, collection, companyData, mappedCompanyData, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, collection.findOne({ company_name: companyName })];
                case 2:
                    companyData = _a.sent();
                    if (!companyData) {
                    ...
                    return [2 /*return*/, mappedCompanyData];
                case 3:
                    err_1 = _a.sent();
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var companyName, companyData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    companyName = "Coupa Cafe";
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetchData(companyName)];
                case 2:
                    companyData = _a.sent();
                    console.log("Company Name:", companyData.company_name);
                    console.log("Company Image:", companyData.company_image);
                    console.log("Items:");
                    companyData.items.forEach(function (item) {
